 ...
 * @author josesito
 */
public class MENU_TSController implements Initializable {
...
public void handle(ActionEvent event) throws IOException {
	...
	if((Button)event.getSource()==hr){
		System.out.println("HOLA");
                ...
                FXMLLoader loader = new FXMLLoader(Prueba.class.getResource("HACER_R.fxml"));
        ...
        Window stagePrincipal = null;
            ...
            System.out.println("HOLA");
		((Node) (event.getSource())).getScene().getWindow().hide();
                FXMLLoader loader = new FXMLLoader(Prueba.class.getResource("CHECAR_P1.fxml"));
        ...
        Window stagePrincipal = null;
            ...
            ((Node) (event.getSource())).getScene().getWindow().hide();
                FXMLLoader loader = new FXMLLoader(Prueba.class.getResource("CHECAR_R.fxml"));
            AnchorPane ventanaPrincipal;
            ventanaPrincipal = (AnchorPane) loader.load();
            Stage ventana = new Stage();
        Window stagePrincipal = null;
            ...
            ((Node) (event.getSource())).getScene().getWindow().hide();
                FXMLLoader loader = new FXMLLoader(Prueba.class.getResource("EDITAR_T.fxml"));
            AnchorPane ventanaPrincipal;
            ventanaPrincipal = (AnchorPane) loader.load();
            Stage ventana = new Stage();
        Window stagePrincipal = null;
