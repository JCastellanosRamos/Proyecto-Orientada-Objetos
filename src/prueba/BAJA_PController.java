 ...
 * @author josesito
 */
public class BAJA_PController implements Initializable {
   ObservableList<String> catList = FXCollections
            .observableArrayList("Id_proveedor", "Usuario");
    /**
    ...
    public void handle(ActionEvent event) throws IOException{
         String prueba = txt.getText();
          String prueba2 = (String) c1.getValue();
             if(prueba.equals("") && prueba2.equals("Id_proveedor") || prueba2.equals("Usuario")){
        ...
        if ((Button) event.getSource() == btn1) {
            try {
                ...
                esp = txt.getText();
                    ...
                    sql = "DELETE FROM `Proveedores` WHERE "+ cat +"="+" '"+esp+"'";
